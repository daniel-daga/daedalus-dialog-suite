...
### Upstreamable as-is — plain ZenKit bugs any consumer wants (24)
...
`0027`, `0029`, `0030`, `0031` and `0032` are the same class of standalone fix — a
one-guard hardening of the read path, reachable by any consumer that opens a file it
did not write. `0029` is the strongest of the five: the bug it stops is an
out-of-bounds write, not a hang or an out-of-bounds read.
...
1. `0020`, `0021`, `0022`, `0027`, `0029`, `0030`, `0031`, `0032` — one PR each.
